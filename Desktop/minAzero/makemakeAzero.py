...
#ADDLIBS = ~/lib/i386-apple-darwin9.1.0/libpardiso_GNU_MACOSX105_INTEL_32.dylib\n\
\n\
...
LIBS = -L$(IPOPTLIBDIR) -lipopt -lpthread -lm  -ldl  -L/usr/lib/gcc/i486-linux-gnu/4.4.3 -L/usr/lib/gcc/i486-linux-gnu/4.4.3/../../../../lib -L/lib/../lib -L/usr/lib/../lib -L/usr/lib/gcc/i486-linux-gnu/4.4.3/../../.. -L/usr/lib/i486-linux-gnu -lgfortranbegin -lgfortran -lm -lgcc_s\n\
